  ...
  async function inipesan(){
    var { value: balas } = await swals.fire({
           title: 'Halo ' + nama + ', baca dengan teliti ya anjg', input: 'text',
       });
       if(balas && balas.length < 20){
         ...
         mulaibalas();
           ...
           await swals.fire('Ups!', 'Balasan tidak boleh kosong atau lebih dari 20 karakter, ya!');inipesan();
    }
  }
  ...
  var nama = 'andarii';
    ...
    async function menuju(){pesanwhatsapp = "Makasii udah ngucapin Aku  Ultah ya epannn";await swals.fire('okee', 'Kirim jawabannya ke WhatsApp aku ya', 'success');window.location = "https://api.whatsapp.com/send?081239409081=&text=" + pesanwhatsapp;}
